...
number: int = 42
concatenated_with_number: str = str1 + " " + str(number)
...
# This will print "Hello, Alex!" to the console, demonstrating that the
...
age: int = 30
concatenated_with_age: str = "Hello, I am %d years old." % age
...
concatenated_with_format: str = "Hello, I am {} years old.".format(age)
...
name: str = "Alex"
age: int = 30
greeting_with_fstring: str = (
    f"Hello, my name is {name} and I am {age} years "
    "old."
)
print(greeting_with_fstring)

# This will print "Hello, my name is Alex and I am 30 years old."
