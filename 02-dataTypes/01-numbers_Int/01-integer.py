...
# As long as you have enough memory you can store as big and as many integers to fill it up in Python 3.
...
# please note this is NOT rounding, it just removes the decimal part and keeps the whole number part.
